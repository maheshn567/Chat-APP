        ...
        <div className="flex flex-col justify-center items-center min-h-screen bg-brand-background px-4">
            <div className="w-full max-w-md bg-brand-surface border border-brand-outline-variant/10 rounded-brand-2xl p-8 shadow-2xl relative">
                ...
                <div className="text-center mb-8 relative z-10">
                    <h1 className="text-3xl font-bold tracking-tight text-brand-on-surface">Welcome back</h1>
                    <p className="text-sm text-brand-on-surface-variant mt-2">Sign in to your account to continue</p>
                </div>
                ...
                <div className="text-center mt-6 relative z-10">
                    <p className="text-sm text-brand-on-surface-variant">
                        ...
                        <Link className="text-brand-primary font-semibold hover:underline" to="/register">
                            Register here
                        </Link>
                    </p>
                </div>
